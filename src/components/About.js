  ...
  return (
    <>
      ...
      <section id="about" className="about pt-0">
        <div className="container-fluid bg-f1f7fd">
          <div className="row carousel-top">
            <h1>Partners</h1>
            <span>We're honored to serve a wide range of clients, from small businesses to Fortune 500 enterprises. Our success is fueled by partnerships with leading banks and financial institutions. These collaborations empower us to offer tailored loan solutions that meet the unique needs of each client.</span>
            <div></div>
          </div>
